...
namespace robomaster {
    ...
    void RoboMaster::boot_sequence() {
        ...
        this->handler_.push_message(Message(DEVICE_ID_INTELLI_CONTROLLER, 0x18c9, 0x04, { 0x00, 0x3f, 0x32, 0x01, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }));
        // this->handler_.push_message(Message(DEVICE_ID_INTELLI_CONTROLLER, 0x04c9, 0x03, { 0x40, 0x04, 0x1e, 0x05, 0xff })); // Enable attitude push info from gimbal, needs to be decoded!
    }
